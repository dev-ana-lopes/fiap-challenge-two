...
async def create_customer(
    ...
    try:
        customer_id = await use_case.execute(
            request.name, request.cpf_cnpj, request.email, request.phone
        )
...
@router.get("")
async def list_customers(customer_repo: CustomerRepo) -> list[CustomerResponse]:
...
async def get_customer(
    customer_id: UUID, customer_repo: CustomerRepo
) -> CustomerResponse:
...
async def delete_customer(customer_id: UUID, customer_repo: CustomerRepo) -> dict:
