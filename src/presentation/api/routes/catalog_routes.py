...
async def create_catalog_service(
    request: CatalogServiceCreateRequest, repo: CatalogServiceRepo
) -> dict:
...
async def update_catalog_service(
    service_id: UUID, request: CatalogServiceUpdateRequest, repo: CatalogServiceRepo
) -> dict:
...
async def delete_catalog_service(service_id: UUID, repo: CatalogServiceRepo) -> dict:
...
async def create_inventory_part(
    request: InventoryPartCreateRequest, repo: InventoryPartRepo
) -> dict:
...
@router.get("/parts")
async def list_inventory_parts(repo: InventoryPartRepo) -> list[InventoryPartResponse]:
...
async def delete_inventory_part(part_id: UUID, repo: InventoryPartRepo) -> dict:
